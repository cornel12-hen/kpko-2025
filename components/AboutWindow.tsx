  ...
  return (
    <div 
      className={`
        ...
        top-full left-0 mt-2 ml-2 rounded-sm
        md:top-auto md:bottom-full md:mb-2 md:ml-2
        bg-[#d9d9d9] border-2 border-[#003566] shadow-solid-md
        animate-in fade-in zoom-in-95 duration-200
      `}
    >
      <div className="bg-[#003566] px-2 py-1 flex items-center gap-2 mb-1">
        <div className="w-2 h-2 rounded-full bg-white animate-pulse"></div>
        <span className="text-white text-xs tracking-wider">OSISTEL 2025/2026</span>
      </div>
      ...
      <div className="bg-white border-2 border-[#003566] p-4 text-center">
        <p className="text-[#000814] text-lg leading-tight">
          ...
          <span className=" text-[#003566]">Panitia KPKO 2025</span>
        </p>
